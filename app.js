        ...
        const fallbackProductsList = [
            {
                id: 'p1',
                sku: 'PG-reg-ownm-500',
                title: '(Pre-order) PustiGen | Oats With Nuts Mix',
                price: 1199,
                originalPrice: 1600,
                discountPercent: 15,
                category: 'Oats Family',
                image: 'https://drive.google.com/thumbnail?id=1vLXDWYDbQstm_U9DKBpww_mK_2zJjr3j&sz=w2000',
                details: 'PustiGen Oats With Nuts Mix – পুষ্টিকর স্বাস্থ্যকর 🌿 আপনার দিনের স্মার্ট ও সুষম শুরু💪 প্রতিদিনের সকাল শুরু করুন PustiGen Oats With Nuts Mix দিয়ে — যেখানে রয়েছে হোয়াইট ওটস, রোস্টেড নাটস, কুমড়ার বীজ এবং প্রাকৃতিকভাবে শুকানো খেজুর, কলা, আপেল ও কিসমিসের সুষম সমন্বয়। প্রতিটি বাটিতে পাবেন দারুণ স্বাদ, হালকা ক্রাঞ্চ এবং প্রাকৃতিক মিষ্টতা — যা আপনার ব্রেকফাস্টকে করবে পুষ্টিকর, সহজ এবং উপভোগ্য। আধুনিক ব্যস্ত জীবনের জন্য তৈরি এই Ready-to-Eat Nutrition Blend আপনাকে দেয় পুষ্টি ও সুবিধা একসাথে।অফিস, পড়াশোনা কিংবা ঘরে শান্ত সকালের জন্য এটি হতে পারে আপনার প্রতিদিনের স্বাস্থ্যকর সঙ্গী।🌟 কেন বেছে নেবেন PustiGen Oats With Nuts Mix?⚡ প্রতিটি চামচে সুষম পুষ্টিকমপ্লেক্স কার্বোহাইড্রেট, হেলদি ফ্যাট ও প্ল্যান্ট-ভিত্তিক প্রোটিনের প্রাকৃতিক সমন্বয় সারাদিন এনার্জি ধরে রাখতে সাহায্য করে।🌾 উচ্চমাত্রার ফাইবারপেট ভরা অনুভূতি দেয় এবং স্বাস্থ্যকর খাদ্যাভ্যাস বজায় রাখতে সহায়ক।🥜 নাটস ও সিডসের পুষ্টিগুণআলমন্ড, আখরোট ও কুমড়ার বীজ যোগ করে দারুণ স্বাদ, ক্রাঞ্চ এবং প্রাকৃতিক পুষ্টি।🍌 প্রাকৃতিক মিষ্টতাখেজুর, কলা, আপেল ও কিসমিসের স্বাদ — কোনো Refined Sugar বা Artificial Sweetener ছাড়াই।⏱ মাত্র ৩–৫ মিনিটে প্রস্তুতদুধ বা পানির সাথে খুব সহজেই তৈরি করা যায় — ব্যস্ত সকালের জন্য একদম পারফেক্ট।🌿 বিশ্বস্ত উপাদানআমরা বিশ্বাস করি পরিষ্কার ও খাঁটি উপাদানে।প্রতিটি প্যাকেট Preservative-Free এবং যত্নসহকারে তৈরি, যাতে থাকে বিশুদ্ধতা ও সতেজতা।উপাদানসমূহ:White OatsRoasted Crushed AlmondsRoasted Crushed WalnutsPumpkin SeedsDate ChunksBlack RaisinsDehydrated Date PowderDehydrated BananaDehydrated Appleপ্রতিটি উপাদান এমনভাবে শুকানো হয়েছে যাতে স্বাদ, গঠন ও পুষ্টিগুণ অক্ষুণ্ণ থাকে।কোনো Artificial Additives নয়, কোনো আপোষ নয়।🥛 প্রস্তুত প্রণালী1️⃣ ১ কাপ দুধ বা পানি মাঝারি আঁচে গরম করুন2️⃣ ৩ টেবিল চামচ PustiGen Mix মেশান3️⃣ ৩–৫ মিনিট নেড়ে রান্না করুন4️⃣ গরম পরিবেশন করুন অথবা Overnight রেখে ঠান্ডা উপভোগ করুন👉 ইচ্ছা করলে মধু, দারুচিনি বা দই যোগ করতে পারেন।👨‍👩‍👧 কার জন্য উপযোগী?✔ ব্যস্ত অফিস কর্মী ও শিক্ষার্থী✔ পরিবার ও শিশুদের স্বাস্থ্যকর ব্রেকফাস্ট✔ স্বাস্থ্য সচেতন মানুষ✔ জিম ও ফিটনেস সচেতন ব্যক্তি✔ Processed Cereal এর স্বাস্থ্যকর বিকল্প খুঁজছেন যারা',
                features: [],
                available: true,
                availableOn: '',
            }
